    ...
    <section id={id} className="py-16 md:py-24 px-6 border-y border-white/10">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-orbitron font-bold mb-4 text-white">Video Lectures</h2>
        ...
        >
          ...
          <div className="flex-1 text-center md:text-left">
            <h3 className="text-2xl font-bold font-orbitron mb-2 group-hover:text-white transition-colors text-[#e8e4df]">
              Slicing Spacetime
            </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-orbitron text-[#e8e4df]">Warp Drive Physics</h3>
          ...
          <div className="flex flex-col">
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-orbitron text-[#e8e4df]">Wormhole Physics</h3>
